...
using prod.MultiTenancy.HostDashboard;
...
namespace prod.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(prodDbContext context, SubscriptionPayment subscriptionPayment)
        {
