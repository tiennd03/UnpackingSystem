...
using prod.Web.Models.Account;
using prod.Security;
using prod.Security.Recaptcha;
using prod.Sessions;
using prod.Url;
using prod.Web.Authentication.External;
using prod.Web.Security.Recaptcha;
using prod.Web.Session;
using prod.Web.Views.Shared.Components.TenantChange;
...
{
    public class AccountController : prodControllerBase
    {
            ...
            string returnUrlHash = "", string ss = "")
        {
            ...
            if (loginResult.User.ShouldChangePasswordOnNextLogin)
            {
                ...
                var expireDate =
                    Uri.EscapeDataString(Clock.Now.AddHours(1).ToString(prodConsts.DateTimeOffsetFormat));
