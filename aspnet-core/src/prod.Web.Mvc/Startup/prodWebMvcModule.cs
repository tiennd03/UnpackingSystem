...
namespace prod.Web.Startup
{
    ...
    public class prodWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public prodWebMvcModule(IWebHostEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(prodWebMvcModule).GetAssembly());
        }
