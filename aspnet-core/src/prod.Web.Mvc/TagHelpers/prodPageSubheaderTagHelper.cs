...
namespace prod.Web.TagHelpers
{
    ...
    public class prodPageSubheaderTagHelper : TagHelper
    {
        ...
        public prodPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
