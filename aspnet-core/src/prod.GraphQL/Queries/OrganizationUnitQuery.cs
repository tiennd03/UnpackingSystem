...
using prod.Core.Base;
using prod.Core.Extensions;
using prod.Dto;
using prod.Types;

namespace prod.Queries
{
    public class OrganizationUnitQuery : prodQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
