  ...
  public sealed class AspNetZeroLicenseChecker : AspNetZeroBaseLicenseChecker, ISingletonDependency
  {
      ...
      string licenseCode)
    {
      ...
      using (HttpClient httpClient = new HttpClient())
      {
        ...
        AjaxResponse<LicenseValidationResult> ajaxResponse = (AjaxResponse<LicenseValidationResult>)JsonConvert.DeserializeObject<AjaxResponse<LicenseValidationResult>>(await httpResponseMessage.Content.ReadAsStringAsync());
