...
{
    public class prodAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public prodAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
