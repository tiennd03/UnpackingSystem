...
{
    public class SessionAppService : prodAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = prodConsts.Currency,
                        CurrencySign = prodConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = prodConsts.AllowTenantsToChangeEmailSettings,
