...
using prod.Auditing.Exporting;
using prod.Authorization;
using prod.Authorization.Users;
using prod.Dto;
using prod.EntityHistory;
using EntityHistoryHelper = prod.EntityHistory.EntityHistoryHelper;

namespace prod.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : prodAppServiceBase, IAuditLogAppService
    {
