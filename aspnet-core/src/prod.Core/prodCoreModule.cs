...
using prod.Authorization.Ldap;
using prod.Authorization.Roles;
using prod.Authorization.Users;
using prod.Chat;
using prod.Configuration;
using prod.DashboardCustomization.Definitions;
using prod.Debugging;
using prod.DynamicEntityProperties;
using prod.Features;
...
{
    [DependsOn(
        typeof(prodCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class prodCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            prodLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = prodConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, prodMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<prodSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(prodCoreModule).GetAssembly());
        }
