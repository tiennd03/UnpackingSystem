...
using prod.Auditing;
using prod.Authorization.Users.Password;
using prod.Configuration;
using prod.EntityFrameworkCore;
using prod.MultiTenancy;
using prod.Web.Startup.ExternalLoginInfoProviders;
...
namespace prod.Web.Startup
{
    ...
    public class prodWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public prodWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(prodWebHostModule).GetAssembly());
        }
