...
namespace prod.Web.Public.Startup
{
    [DependsOn(
        typeof(prodWebCoreModule)
    )]
    public class prodWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public prodWebFrontEndModule(IWebHostEnvironment env, prodEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(prodWebFrontEndModule).GetAssembly());
        }
    }
}
