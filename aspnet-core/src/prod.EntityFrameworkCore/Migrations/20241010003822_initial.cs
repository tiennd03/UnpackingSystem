        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BinName = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    BinType = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    CreationMinAmount = table.Column<int>(type: "int", nullable: true),
                    CreationFixedFee = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CreationPercentFee = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    FundingMinAmount = table.Column<int>(type: "int", nullable: true),
                    FundingFixedFee = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    FundingPercentFee = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CmmBin", x => x.Id);
                });
