...
{
    public class SubscriptionPaymentExtensionDataRepository : prodRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<prodDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
