...
namespace prod.Organizations
{
    public class UserOrganizationUnitRepository : prodRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<prodDbContext> dbContextProvider)
